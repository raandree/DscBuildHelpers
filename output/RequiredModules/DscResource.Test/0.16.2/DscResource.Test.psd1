@{
    ...
    AliasesToExport   = @('Get-ObjectNotFoundRecord','Task.Fail_Build_If_HQRM_Tests_Failed','Task.Invoke_HQRM_Tests_Stop_On_Fail','Task.Invoke_HQRM_Tests','Task.Invoke_HQRM_Tests','Task.Fail_Build_If_HQRM_Tests_Failed','Task.Invoke_HQRM_Tests_Stop_On_Fail')
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes               = '## [0.16.2] - 2023-05-18
